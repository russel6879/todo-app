						...
						<table>
							<tr>
								<td>
								 ...
								 @if($data->customer){{$data->customer->name}}@endif<br/>
								 @if($data->customer){{$data->customer->email}}@endif<br/>
								 @if($data->customer){{$data->customer->phone}}@endif<br/>
								 @if($data->customer){{$data->customer->address}}@endif
