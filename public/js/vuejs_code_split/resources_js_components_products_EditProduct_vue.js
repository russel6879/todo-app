...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/products/EditProduct.vue?vue&type=script&lang=js&":
/*!***************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/components/products/EditProduct.vue?vue&type=script&lang=js& ***!
  \***************************************************************************************************************************************************************************************************************************/
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data: function data() {
    return {
      ...
      image: '',
      // 				images: [ {
      //     path: 'https://www.kalerkantho.com/assets/news_images/2022/10/30/100447KalerKantho_pic.jpg',
      //   }],
      multiVarantis: false
    };
  },
  ...
  methods: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_1__.mapActions)(["fetchCategories", "fetchBrands", "fetchParrentUnits", "addProduct"])), {}, {
    editProduct: function editProduct() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().get('api/product/' + this.$route.params.id).then(function (res) {
        console.log(res.data);
        _this.name = res.data.name;
        _this.product_code = res.data.product_code;
        _this.category_id = res.data.category_id;
        _this.brand_id = res.data.brand_id;
        _this.barcode_symbology = res.data.barcode_symbology;
        _this.product_cost = res.data.product_cost;
        _this.product_price = res.data.product_price;
        _this.unit_id = res.data.unit_id;
        _this.sale_unit = res.data.sale_unit;
        _this.purchase_unit = res.data.purchase_unit;
        _this.serial_number = res.data.serial_number;
        _this.stock_alert_qt = res.data.stock_alert_qt;
        _this.tax = res.data.tax;
        _this.tax_type = res.data.tax_type;
        _this.varantis = res.data.varantis;
        _this.description = res.data.description;
        _this.image = res.data.images;

        _this.selectedUnit(res.data.unit_id); //    this.images=this.viewImage();
        //    this.markIsPrimary(0,res.data.images)
        //    this.editImage(res.data.images,0,0);
        //    this.formData=res.data.images
    ...
    onProductSubmit: function onProductSubmit() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().put('api/product/' + this.$route.params.id, {
        name: this.name,
    ...
    selectedUnit: function selectedUnit(id) {
      var _this3 = this;
    ...
    productImage: function productImage() {
      ...
      if (photo.length > 100) {
        ...
        return "productImages//".concat(this.image);
      }
    },
